...
func (e *Chromium) AddWebResourceRequestedFilter(filter string, ctx jchv.COREWEBVIEW2_WEB_RESOURCE_CONTEXT) {
	if e.webview == nil {
		//console.MessageBoxPlain("webview", "!exists")
	}
...
func (e *Chromium) AcceleratorKeyPressed(sender *ICoreWebView2Controller, args *ICoreWebView2AcceleratorKeyPressedEventArgs) uintptr {
	...
	if eventKind == jchv.COREWEBVIEW2_KEY_EVENT_KIND_KEY_DOWN ||
		eventKind == jchv.COREWEBVIEW2_KEY_EVENT_KIND_SYSTEM_KEY_DOWN {
...
func (e *Chromium) GetSettings() (*jchv.ICoreWebViewSettings, error) {
...
func (e *Chromium) Focus() {
	...
	_ = e.controller.MoveFocus(jchv.COREWEBVIEW2_MOVE_FOCUS_REASON_PROGRAMMATIC)
}
